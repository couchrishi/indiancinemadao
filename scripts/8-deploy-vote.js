...
const appModule = sdk.getAppModule(
  "0xa0b2be228328d9394411232e885D24C2b9272250"
);
...
(async () => {
  try {
    const voteModule = await appModule.deployVoteModule({
      ...
      name: "Indian Cinema Proposals",

      // This is the location of our governance token, our ERC-20 contract!
      votingTokenAddress: "0xA21123e4a201D1227E46536F4A1CA63D89fdd6AA",
      ...
      // What's the minimum no. of tokens a user needs to be allowed to create a proposal?
